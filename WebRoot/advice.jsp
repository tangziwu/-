	...
	<body>
		<div id="box">
					...
					<Div class="right_box" style="height:550px">
						<div class="right_topBar">
							<ul>
									...
									<li>
										<a href="announcement.jsp"  style="height:30px;width:63px;margin-top:7px;margin-left:550px;	background:#98FB98;color: #FFFFFF">新增</a>
									</li>
									<li>
						...
						<div class="content_box" style="height:550px">
						 ...
						 <tr>
                            <td  height="35"width="30" align="center" bgcolor="	#6495ED"><input type="checkbox" id="selAll" onclick="foodall()" /></td>
                  ...
                  <s:iterator var="inform" value="list"> 
                   <tr id="<s:property value='#inform.id'/>">
                                ...
                                <td height="35" bgcolor="#FFFFFF"  align="center">
									<a class="a1" href="informAction_remove?inform.id=<s:property value="#inform.id"/>">删除</a>
                             ...
                             <a href="informAction_findAll.action?currPage=1">[首页]</a>&nbsp;&nbsp;
                             <a href="informAction_findAll.action?currPage=<s:property value="currPage-1"/>">[上一页]</a>&nbsp;&nbsp;
                             </s:if>
                             <s:if test="currPage != totalPage">
                             <a href="informAction_findAll.action?currPage=<s:property value="currPage+1"/>">[下一页]</a>&nbsp;&nbsp;
                             <a href="informAction_findAll.action?currPage=<s:property value="totalPage"/>">[尾页]</a>&nbsp;&nbsp;
                             </s:if>
			...
			<div id="left_nav" class="left_menu">
				...
				<div class="menu_list">
					<ul>
						<li><a href="informAction_find">信息管理</a></li>
